...
let storyText = '外は華氏94度で暑かったが、:insertx:は散歩に行きました。:insertx:は:inserty:。しばらく歩いていると:insertz:. Bobはそれを見て驚いたが,体重300ポンドの:insertx:は驚かなかった。なぜなら:inserty:では当たり前のことであるからだ。';
